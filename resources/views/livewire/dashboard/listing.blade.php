<div class="">
    ...
    <div class="xl:flex">
        <div class="relative overflow-x-auto rounded-lg mb-10 xl:mb-0 xl:mr-10 xl:w-1/2">
            <div class="bg-white border-b dark:bg-green-800 dark:border-green-700 hover:bg-green-600">
        ...
        <div
            class="relative overflow-x-auto rounded-lg xl:mb-0 xl:w-1/2 bg-white border-b dark:bg-purple-800 dark:border-purple-700 hover:bg-purple-600">
            <div class="bg-white border-b dark:bg-purple-800 dark:border-purple-700 hover:bg-purple-600">
